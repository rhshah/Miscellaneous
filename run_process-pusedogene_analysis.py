"""
run_process-psuedogene_analysis
~~~~~~~~~~~~~~~~

:Description: run_process-psuedogene_analysis is a wrapper to run the process-psuedogene on MSKCC data
:author:     Ronak H Shah
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='run_process-psuedogene_analysis.py',
        description='Run run_process-psuedogene_analysis on selected pools/samples using MSK data',
    ...
    parser.add_argument(
        ...
        help="Full path processpsuedogene.py executables.")
    parser.add_argument(
        "-ias",
        "--iAnnotateSV",
        action="store",
    ...
    parser.add_argument(
        ...
        default='5',
        metavar='5',
        help="Number of Threads to be used to run process-psuedogene analysis on")
    parser.add_argument(
        "-v",
        "--verbose",
        action="store_true",
